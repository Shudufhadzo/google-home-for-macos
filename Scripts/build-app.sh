...
swift build --configuration "$configuration" --disable-sandbox --scratch-path .build

app_dir="$project_dir/dist/HomeSpeaker.app"
mkdir -p "$app_dir/Contents/MacOS" "$app_dir/Contents/Resources"
cp "$project_dir/.build/$configuration/HomeSpeaker" "$app_dir/Contents/MacOS/HomeSpeaker"
